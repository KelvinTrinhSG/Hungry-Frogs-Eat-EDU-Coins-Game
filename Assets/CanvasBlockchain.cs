...
public class CanvasBlockchain : MonoBehaviour
{
    ...
    private string ERC20TokenSmartContractAddress = "0xA9DC1d7955E2dEA8bEd9eE0638b4d12951De3Bd8";
    ...
    public async void ClaimGold()
    {
        ...
        var contract = ThirdwebManager.Instance.SDK.GetContract(ERC20TokenSmartContractAddress);
